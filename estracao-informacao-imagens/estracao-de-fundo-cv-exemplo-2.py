#bem susedido mais precisa de testes futuros pois não é sufucientemente boa
...
img = cv.imread('img/entrada/folha-de-mamao.jpg', cv.IMREAD_UNCHANGED)
original = img.copy()
...
result[mask ==  0] =  255
cv.imwrite('img/saida/bg.png', result)

img = Image.open('img/saida/bg.png')
img.convert("RGBA")
datas = img.getdata()
...
img.putdata(newData)
img.save("img/saida/img.png", "PNG")